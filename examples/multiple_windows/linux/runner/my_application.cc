...
static void my_application_activate(GApplication* application) {
  ...
  GtkWidget* title_label = gtk_label_new("multiple_windows");
  gtk_header_bar_set_title_widget(header_bar, title_label);
  gtk_window_set_titlebar(window, GTK_WIDGET(header_bar));
  gtk_window_set_title(window, "multiple_windows");
#else
  ...
  if (use_header_bar) {
    ...
    gtk_header_bar_set_title(header_bar, "multiple_windows");
